...
export type Screen = 'home' | 'doniraj' | 'clanarina' | 'projekti' | 'nagrade' | 'aktivnost' | 'primi' | 'glasovanje';

// Glasovanje ima tab (slogan je „Vaš glas. Vaša odluka."); Primi ostaje na
// Home quick-akcijama i u desktop navigaciji.
const TABS: { key: Screen; label: string; icon: string }[] = [
  ...
  { key: 'glasovanje', label: 'Glasovanje', icon: 'm9 12 2 2 4-4M5 7c0-1.1.9-2 2-2h10a2 2 0 012 2v12H5V7zM22 19H2' },
...
const SCREEN_DOCS: Record<DocKey, { title: string; points: string[] }> = {
  ...
  glasovanje: {
    title: 'Glasovanje · 1 osoba = 1 glas',
    points: [
      'Anti-sybil: passkey identitet + članstvo (za zatvorene odluke) — bez botova i lažnih računa.',
      'Glas se bilježi onchain — tally je javan i provjerljiv u stvarnom vremenu.',
      'Sudjelovanje nosi edEUR (soulbound) — priznanje, ne prenosivi novac; prenosiva nagrada bi stvorila sybil-farmu.',
      'Formalne odluke donose Skupština i UO — glasovanje je savjetodavni signal i temelj participativnog budžeta.',
    ],
  },
  primi: {
    title: 'Primi · QR + SEPA',
